"""
Django settings for request_management project.
...
SECRET_KEY = 'django-insecure-_^6cmrzf$8_qmuf@r4hv8j4dfc^yy^et2$-ppc5*-b%ld_%chb'
...
ROOT_URLCONF = 'request_management.urls'
...
WSGI_APPLICATION = 'request_management.wsgi.application'
